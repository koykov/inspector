...
func (i7 TestPermissionInspector) GetTo(src interface{}, buf *interface{}, path ...string) (err error) {
	...
	if len(path) > 0 {
		var k int32
		t285, err285 := strconv.ParseInt(path[0], 0, 0)
		if err285 != nil {
			return err285
		}
		k = int32(t285)
...
func (i7 TestPermissionInspector) Cmp(src interface{}, cond inspector.Op, right string, result *bool, path ...string) (err error) {
	...
	if len(path) > 0 {
		var k int32
		t286, err286 := strconv.ParseInt(path[0], 0, 0)
		if err286 != nil {
			return err286
		}
		k = int32(t286)
		...
		_ = x0
		var rightExact bool
		t287, err287 := strconv.ParseBool(right)
		if err287 != nil {
			return err287
		}
		rightExact = bool(t287)
...
func (i7 TestPermissionInspector) SetWB(dst, value interface{}, buf inspector.AccumulativeBuffer, path ...string) error {
	...
	if len(path) > 0 {
		var k int32
		t288, err288 := strconv.ParseInt(path[0], 0, 0)
		if err288 != nil {
			return err288
		}
		k = int32(t288)
