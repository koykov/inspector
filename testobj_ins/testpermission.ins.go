...
func (i7 TestPermissionInspector) GetTo(src interface{}, buf *interface{}, path ...string) (err error) {
	...
	if len(path) > 0 {
		var k int32
		t98, err98 := strconv.ParseInt(path[0], 0, 0)
		if err98 != nil {
			return err98
		}
		k = int32(t98)
...
func (i7 TestPermissionInspector) Cmp(src interface{}, cond inspector.Op, right string, result *bool, path ...string) (err error) {
	...
	if len(path) > 0 {
		var k int32
		t99, err99 := strconv.ParseInt(path[0], 0, 0)
		if err99 != nil {
			return err99
		}
		k = int32(t99)
		...
		_ = x0
		var rightExact bool
		t100, err100 := strconv.ParseBool(right)
		if err100 != nil {
			return err100
		}
		rightExact = bool(t100)
...
func (i7 TestPermissionInspector) SetWB(dst, value interface{}, buf inspector.AccumulativeBuffer, path ...string) error {
	...
	if len(path) > 0 {
		var k int32
		t101, err101 := strconv.ParseInt(path[0], 0, 0)
		if err101 != nil {
			return err101
		}
		k = int32(t101)
