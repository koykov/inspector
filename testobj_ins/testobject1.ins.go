	...
	if len(path) > 0 {
		...
		if path[0] == "IntPtrSlicePtr" {
			...
			if len(path) > 1 {
				...
				var i int
				t261, err261 := strconv.ParseInt(path[1], 0, 0)
				if err261 != nil {
					return err261
				}
				i = int(t261)
		...
		if path[0] == "BytePtrSlice" {
			...
			if len(path) > 1 {
				var i int
				t262, err262 := strconv.ParseInt(path[1], 0, 0)
				if err262 != nil {
					return err262
				}
				i = int(t262)
		...
		if path[0] == "BytePtrSlicePtr" {
			...
			if len(path) > 1 {
				...
				var i int
				t263, err263 := strconv.ParseInt(path[1], 0, 0)
				if err263 != nil {
					return err263
				}
				i = int(t263)
		...
		if path[0] == "FloatSlice" {
			...
			if len(path) > 1 {
				var i int
				t264, err264 := strconv.ParseInt(path[1], 0, 0)
				if err264 != nil {
					return err264
				}
				i = int(t264)
		...
		if path[0] == "FloatPtrSlice" {
			...
			if len(path) > 1 {
				var i int
				t265, err265 := strconv.ParseInt(path[1], 0, 0)
				if err265 != nil {
					return err265
				}
				i = int(t265)
		...
		if path[0] == "FloatSlicePtr" {
			...
			if len(path) > 1 {
				...
				var i int
				t266, err266 := strconv.ParseInt(path[1], 0, 0)
				if err266 != nil {
					return err266
				}
				i = int(t266)
		...
		if path[0] == "FloatPtrSlicePtr" {
			...
			if len(path) > 1 {
				...
				var i int
				t267, err267 := strconv.ParseInt(path[1], 0, 0)
				if err267 != nil {
					return err267
				}
				i = int(t267)
		...
		if path[0] == "StructSlice" {
			...
			if len(path) > 1 {
				var i int
				t268, err268 := strconv.ParseInt(path[1], 0, 0)
				if err268 != nil {
					return err268
				}
				i = int(t268)
		...
		if path[0] == "StructPtrSlice" {
			...
			if len(path) > 1 {
				var i int
				t269, err269 := strconv.ParseInt(path[1], 0, 0)
				if err269 != nil {
					return err269
				}
				i = int(t269)
		...
		if path[0] == "StructSlicePtr" {
			...
			if len(path) > 1 {
				...
				var i int
				t270, err270 := strconv.ParseInt(path[1], 0, 0)
				if err270 != nil {
					return err270
				}
				i = int(t270)
		...
		if path[0] == "StructPtrSlicePtr" {
			...
			if len(path) > 1 {
				...
				var i int
				t271, err271 := strconv.ParseInt(path[1], 0, 0)
				if err271 != nil {
					return err271
				}
				i = int(t271)
		...
		if path[0] == "StructSliceLiteral" {
			...
			if len(path) > 1 {
				var i int
				t272, err272 := strconv.ParseInt(path[1], 0, 0)
				if err272 != nil {
					return err272
				}
				i = int(t272)
		...
		if path[0] == "IntStringMap" {
			...
			if len(path) > 1 {
				var k int
				t273, err273 := strconv.ParseInt(path[1], 0, 0)
				if err273 != nil {
					return err273
				}
				k = int(t273)
		...
		if path[0] == "IntStringPtrMap" {
			...
			if len(path) > 1 {
				var k int
				t274, err274 := strconv.ParseInt(path[1], 0, 0)
				if err274 != nil {
					return err274
				}
				k = int(t274)
		...
		if path[0] == "IntStringMapPtr" {
			...
			if len(path) > 1 {
				...
				var k int
				t275, err275 := strconv.ParseInt(path[1], 0, 0)
				if err275 != nil {
					return err275
				}
				k = int(t275)
		...
		if path[0] == "IntStringPtrMapPtr" {
			...
			if len(path) > 1 {
				...
				var k int
				t276, err276 := strconv.ParseInt(path[1], 0, 0)
				if err276 != nil {
					return err276
				}
				k = int(t276)
		...
		if path[0] == "IntPtrStringPtrMapPtr" {
			...
			if len(path) > 1 {
				...
				var k int
				t277, err277 := strconv.ParseInt(path[1], 0, 0)
				if err277 != nil {
					return err277
				}
				k = int(t277)
		...
		if path[0] == "IntIntMapMap" {
			...
			if len(path) > 1 {
				var k int32
				t278, err278 := strconv.ParseInt(path[1], 0, 0)
				if err278 != nil {
					return err278
				}
				k = int32(t278)
				...
				if len(path) > 2 {
					var k int32
					t279, err279 := strconv.ParseInt(path[2], 0, 0)
					if err279 != nil {
						return err279
					}
					k = int32(t279)
		...
		if path[0] == "FloatStructMap" {
			...
			if len(path) > 1 {
				var k float64
				t280, err280 := strconv.ParseFloat(path[1], 0)
				if err280 != nil {
					return err280
				}
				k = float64(t280)
		...
		if path[0] == "FloatStructPtrMap" {
			...
			if len(path) > 1 {
				var k float64
				t281, err281 := strconv.ParseFloat(path[1], 0)
				if err281 != nil {
					return err281
				}
				k = float64(t281)
		...
		if path[0] == "FloatPtrStructMap" {
			...
			if len(path) > 1 {
				var k float64
				t282, err282 := strconv.ParseFloat(path[1], 0)
				if err282 != nil {
					return err282
				}
				k = float64(t282)
		...
		if path[0] == "FloatPtrStructPtrMap" {
			...
			if len(path) > 1 {
				var k float64
				t283, err283 := strconv.ParseFloat(path[1], 0)
				if err283 != nil {
					return err283
				}
				k = float64(t283)
		...
		if path[0] == "FloatPtrStructPtrMapPtr" {
			...
			if len(path) > 1 {
				...
				var k float64
				t284, err284 := strconv.ParseFloat(path[1], 0)
				if err284 != nil {
					return err284
				}
				k = float64(t284)
