		...
		if len(*x) > i {
			...
			if len(path) > 1 {
				...
				if path[1] == "F" {
					...
					t418, err418 := strconv.ParseFloat(right, 0)
					if err418 != nil {
						return err418
					}
					rightExact = float32(t418)
					switch cond {
					case inspector.OpEq:
